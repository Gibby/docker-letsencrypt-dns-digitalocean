...
function deploy_challenge {
    ...
    doctl compute domain records create ${DOMAIN} --record-type TXT --record-name "_acme-challenge.${SUBDOMAIN}" --record-data "${TOKEN_VALUE}"
...
function deploy_cert {
    ...
    bash /srv/letsencrypt/do_deploy.sh $@
